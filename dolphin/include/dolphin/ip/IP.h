...
struct IPInterface {
    ...
    BOOL (*free)(IPInterface*, void*, s32); // offset 0x70, size 0x4
    BOOL (*inFilter)(IPInterface*, void*, s32); // offset 0x74, size 0x4
    BOOL (*outFilter)(IPInterface*, void*, s32); // offset 0x78, size 0x4
